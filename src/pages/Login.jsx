...
const titleStyle = { fontSize: '22px', fontWeight: '900', color: '#FFF', marginBottom: '24px', textAlign: 'center' }
const inputStyle = {
  width: '100%', background: '#08080F', border: '1px solid #2A2A3E',
  color: '#E0E0E0', padding: '12px 16px', borderRadius: '4px',
  fontSize: '14px', fontFamily: "'Courier New', monospace", outline: 'none'
}
const btnStyle = {
  width: '100%', background: '#00FFB2', color: '#000', border: 'none',
  padding: '13px', borderRadius: '4px', cursor: 'pointer',
  fontWeight: '700', fontSize: '15px', fontFamily: "'Courier New', monospace", marginTop: '4px'
}
const errorStyle = {
  background: '#FF3B3B15', border: '1px solid #FF3B3B40',
  color: '#FF3B3B', padding: '10px 14px', borderRadius: '4px',
